...
/**
 * Specific formatter used for every messages coming from logging activities
 * wanted on standard output and logging file.
 * <p>
 * Used by default by 'log.properties'.
 * <p>
 * You can define your own logging properties file using default formatters, or
 * your own dedicated handlers and formatters.
 * <p>
 * To use those specific logging properties, identity location of
 * 'log.properties' file via next VM argument:
 * -Djava.util.logging.config.file=[your path]/log.properties
 * 
 * @author egeay
 */
public final class SimplifiedFormatter extends Formatter {
  ...
  /**
   * Formats the given log record and returns the formatted string. This
   * specific formatter do not show the time and shows the source information
