 ...
 * @author yahave
 * 
 * a sound solver that uses must-alias to do strong updates
 * 
 * This solver relies on global may alias always, which can be a source of
 * imprecision.
 * 
 */
public class MustAPSolver extends AbstractMustAPSolver {
  ...
  protected TypeStateProblem createTypeStateProblem(ICFGSupergraph supergraph, Collection<InstanceKey> instances)
    ...
    return new TypeStateProblem(supergraph, getDomain(), new MustAPFunctionProvider(getCallGraph(), getPointerAnalysis(),
