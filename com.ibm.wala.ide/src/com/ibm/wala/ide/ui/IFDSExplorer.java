...
public class IFDSExplorer {
  ...
  public static <T, P, F> void viewIFDS(TabulationResult<T, P, F> r, Collection<? extends P> roots) throws WalaException {
    viewIFDS(r, roots, null, new IFDSEdgeDecorator());
  }

  public static <T, P, F> void viewIFDS(TabulationResult<T, P, F> r, Collection<? extends P> roots, NodeDecorator labels, EdgeDecorator edgeLabels)
    ...
    viewIFDS(r, roots, labels, edgeLabels, scratch);
  }
 
  public static <T, P, F> void viewIFDS(TabulationResult<T, P, F> r, Collection<? extends P> roots, NodeDecorator labels,
       EdgeDecorator edgeLabels, String scratchDirectory) throws WalaException {
    if (r == null) {
    ...
    ViewIFDSLocalAction<T, P, F> action = (labels == null ? new ViewIFDSLocalAction<T, P, F>(v, r, outputFile, dotFile, dotExe,
        viewerExe, edgeLabels) : new ViewIFDSLocalAction<T, P, F>(v, r, outputFile, dotFile, dotExe, viewerExe, labels, edgeLabels));
